<div class="modal fade" id="createProducts" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true"
    wire:ignore.self>
    <div class="modal-dialog modal-dialog-centered modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">{{ __('Create new product') }}</h5>
                ...
                <div class="row">
                    <div class="col-md-6 col-12 mb-3">
                        ...
                        <input type="text" class="form-control @error('product_name') is-invalid @enderror"
                            placeholder="{{ __('Product name') }}" wire:model.defer="product_name" wire:target="store"
                    ...
                    <div class="col-md-3 col-12 mb-3">
                        ...
                        <input type="number" class="form-control @error('price') is-invalid @enderror"
                            wire:model.defer="price" wire:target="store" wire:loading.attr="disabled" min="1">
                        @error('price')
                            <div class="invalid-feedback ">{{ $message }} </div>
                        @enderror
                    </div>
                    <div class="col-md-3 col-12 mb-3">
                        ...
                        <input type="number" class="form-control @error('stock') is-invalid @enderror"
                            wire:model.defer="stock" wire:target="store" wire:loading.attr="disabled" min="1">
                        @error('stock')
                            <div class="invalid-feedback ">{{ $message }} </div>
                        @enderror
                    </div>
                        ...
                        <div class="d-flex">
                            <div class="col-md-4 col-6 mb-1">
                                <select class="form-control @error('type_wheight') is-invalid @enderror"
                                    wire:model.defer="type_wheight" wire:target="store" wire:loading.attr="disabled">
                            ...
                            <div class="col-md-8 col-6 mb-1" style="margin-left: 5px">
                                <input type="number" class="form-control @error('weight') is-invalid @enderror"
                                    wire:model.defer="weight" wire:target="store" wire:loading.attr="disabled"
                                    min="1">
                                @error('weight')
                                    <div class="invalid-feedback ">{{ $message }} </div>
                                @enderror
